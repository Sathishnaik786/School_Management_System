...
const STATIC_PAGES: SearchResult[] = [
    ...
    { id: 'exams', label: 'Exam Management', sub: 'Manage exams and schedules', href: '/app/exams/manage', icon: GraduationCap, category: 'Exams' },
    { id: 'marks-entry', label: 'Marks Entry', sub: 'Enter student marks', href: '/app/exams/marks-entry', icon: BookOpen, category: 'Exams' },
