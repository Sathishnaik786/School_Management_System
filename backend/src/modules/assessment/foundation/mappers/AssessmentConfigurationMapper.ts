...
export class AssessmentConfigurationMapper {
    public static toDTO(entity: any): AssessmentConfigurationDTO {
    ...
    public static toEntity(dto: AssessmentConfigurationDTO): any {
        if (!dto) return null;
        return {
            id: dto.id,
