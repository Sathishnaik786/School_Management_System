...
import { QuestionStatisticsRepository } from '../repositories/QuestionStatisticsRepository';
import { supabase } from '../../../../config/supabase';

export class QuestionAnalyticsService extends BaseService {
    private readonly repo = new QuestionStatisticsRepository();

    public async calculateQuestionStats(
