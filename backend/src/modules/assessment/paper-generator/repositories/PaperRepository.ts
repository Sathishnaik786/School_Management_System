...
export class PaperRepository extends BaseRepository<any> {
    constructor() {
    ...
    public async findPaperById(paperId: string, schoolId: string): Promise<any | null> {
        ...
        // Validation logs
        const { data: validationLogs, error: valError } = await supabase
    ...
    public async createPaper(schoolId: string, payload: any): Promise<any> {
    ...
    public async updatePaper(paperId: string, schoolId: string, payload: any): Promise<any> {
        const { data, error } = await supabase
            .from(this.tableName)
            .update({
                ...payload,
    ...
    public async deletePaper(paperId: string, schoolId: string): Promise<void> {
