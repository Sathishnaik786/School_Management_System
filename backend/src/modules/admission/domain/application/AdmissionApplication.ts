export type ApplicationStatus = 'DRAFT' | 'IN_PROGRESS' | 'UNDER_REVIEW' | 'CORRECTION_REQUIRED' | 'SUBMITTED' | 'DOCS_PENDING' | 'DOCUMENT_VERIFIED' | 'EXAM' | 'INTERVIEW' | 'MERIT' | 'OFFERED' | 'FEE_PENDING' | 'FEE_VERIFIED' | 'ENROLLED';
