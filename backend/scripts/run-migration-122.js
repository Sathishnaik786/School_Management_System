...
async function main() {
    console.log("Applying migration 122_exam_violation_and_indexes.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/122_exam_violation_and_indexes.sql');
    ...
    console.log("✅ Migration 122 successfully applied!");
}
