...
async function main() {
    console.log("Applying migration 121_admission_officer_rbac_fix.sql...");
    const sqlPath = path.join(__dirname, '../database/migrations/121_admission_officer_rbac_fix.sql');
    ...
    console.log("✅ Migration 121 successfully applied!");
}
